(() => {
    ...
    (() => {
        ...
        function transitionStart_transitionStart(runCallbacks, direction) {
            if (void 0 === runCallbacks) runCallbacks = true;
            const swiper = this;
            const {params} = swiper;
        ...
        function initSliders() {
            bildSliders();
            if (document.querySelector(".plans__slider_one")) new core(".plans__slider_one", {
                modules: [ Pagination ],
                scrollbar: {
                ...
                on: {
                    init: function(swiper) {
                        ...
                        function getValue() {
                            ...
                            if (this.value > 50) this.value = this.value.substr(0, 1);
            ...
            if (document.querySelector(".plans__slider_two")) new core(".plans__slider_two", {
                modules: [ Pagination ],
                scrollbar: {
                    container: ".swiper-wrapper",
                    hide: false,
            ...
            if (document.querySelector(".clients-reviews__slider")) new core(".clients-reviews__slider", {
                modules: [ Autoplay ],
                autoplay: {
                    delay: 800,
            ...
            if (document.querySelector(".reviews-clients__slilder")) new core(".reviews-clients__slilder", {
                modules: [ Pagination ],
                scrollbar: {
                    container: ".swiper-wrapper",
                    hide: false,
        ...
        window.addEventListener("scroll", (() => {
            if (scrollPosition() > lastScroll && !containHide() && scrollPosition() > defaultOffset) header.classList.add("_hide"); else if (scrollPosition() < lastScroll && containHide()) header.classList.remove("_hide");
        ...
        typesItems.forEach(((element, i) => {
            if (0 === i) element.classList.add("types-crm__item_chess");
            if (1 === i) element.childNodes[1].classList.add("types-crm__image_crm");
            if (2 === i) element.childNodes[1].classList.add("types-crm__image_crm");
            if (3 === i) element.childNodes[1].classList.add("types-crm__image_an");
            if (4 === i) element.childNodes[3].classList.add("w50wh");
        }));
        ...
        itemsSlideOne.forEach(((element, i) => {
            if (0 === i) element.setAttribute("id", "12");
            if (1 === i) element.setAttribute("id", "35");
            if (2 === i) element.setAttribute("id", "69");
            if (3 === i) element.setAttribute("id", "10");
        }));
        itemsSlideTwo.forEach(((element, i) => {
            if (0 === i) element.setAttribute("id", "13");
            if (1 === i) element.setAttribute("id", "47");
            if (2 === i) element.setAttribute("id", "811");
            if (3 === i) {
        ...
        itemsStepValue.forEach(((element, i) => {
            if (49 === i) element.classList.add("list-item-step__value_sm");
            if (50 === i) element.classList.add("list-item-step__value_sm");
        }));
        ...
        btnsNext.forEach((btn => {
            ...
            btn.disabled = true;
            if (btn.classList.contains("quiz-form__button_start")) btn.disabled = false;
        }));
        ...
        function initQuiz() {
            quizeItems.forEach(((element, i) => {
                ...
                if (i === count) element.classList.add("_active");
            }));
        }
...
//                 e.target;
//                 const inputsChecked = quizeItem.querySelectorAll("input:checked");
//                 if (inputsChecked.length > 0) btnsNext[quizeItemIndex].disabled = false; else btnsNext[quizeItemIndex].disabled = true;
//             }));
//         }));
